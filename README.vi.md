...
> Ảnh minh họa giao diện được chụp từ một lần sử dụng Discord thực tế. Các chức năng được triển khai đúng như mô tả trong README; ảnh không phải do AI tạo ra.
